package com.jian.jianpicturebackend.manager.auth;
...
import com.jian.jianpicturebackend.model.enums.SpaceRoleEnum;
import com.jian.jianpicturebackend.model.enums.SpaceTypeEnum;
import com.jian.jianpicturebackend.service.PictureService;
import com.jian.jianpicturebackend.service.SpaceService;
import com.jian.jianpicturebackend.service.SpaceUserService;
...
import static com.jian.jianpicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceUserId != null) {
            ...
            // 私有空间的创建者始终拥有管理员权限，防止被成员角色（如 viewer）降级后无法管理
            Space space = spaceService.getById(spaceUser.getSpaceId());
            if (space != null && space.getSpaceType() == SpaceTypeEnum.PRIVATE.getValue()
                    && space.getUserId().equals(userId)) {
                return ADMIN_PERMISSIONS;
            }
