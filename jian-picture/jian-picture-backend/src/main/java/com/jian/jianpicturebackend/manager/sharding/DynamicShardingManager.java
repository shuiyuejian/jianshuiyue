package com.jian.jianpicturebackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // jian_picture.picture_112321321,jian_picture.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "jian_picture." + tableName) // 确保前缀合法
